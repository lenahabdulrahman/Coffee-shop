...
public class BrowseEmps extends javax.swing.JFrame {
    ...
    void Browse()
    {
         try
        {
        ProductsTbl1.setModel(DbUtils.resultSetToTableModel(Employee.SelectAll())); 
        }
        catch(Exception e)
        {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton_signup1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 70, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrowseEmps.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new BrowseEmps().setVisible(true);
            }
        });
    }
